                    ...
                    <tr data-type="${type}" data-id="${examId}">
                        ...
                        <td>
                            <select class="form-control status-select" style="min-width:100px;">
                                ${type === 'สอบโครงร่างวิทยานิพนธ์' || type === 'สอบป้องกันวิทยานิพนธ์' ? `
...
window.downloadExamCSVTemplate = function() {
    ...
    const sampleRows = [
        ['65100503002', 'สอบวัดความรู้ภาษาอังกฤษ', 'ผ่าน', '7.5/9', '2024-03-25', 'ผ่านเกณฑ์ภาษาอังกฤษ'],
        ['65100503002', 'สอบหัวข้อวิทยานิพนธ์', 'ผ่าน', 'Pass', '2024-02-10', ''],
        ['65100503002', 'สอบโครงร่างวิทยานิพนธ์', 'ผ่านแบบมีเงื่อนไข', 'Pass', '2024-04-15', 'แก้เอกสารเพิ่มเติม'],
        ['', '', '', '', '', ''],
        ['* คำชี้แจง:', '', '', '', '', ''],
